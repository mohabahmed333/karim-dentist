...
export const CONTACT_SETTING_FIELDS = [
  ...
  { id: "contact_latitude", label: "Latitude (for maps + structured data)" },
  { id: "contact_longitude", label: "Longitude (for maps + structured data)" },
  { id: "contact_price_range", label: "Price range (e.g. $$)" },
