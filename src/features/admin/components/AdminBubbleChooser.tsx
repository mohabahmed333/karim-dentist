    ...
    >
      ...
      >
        <span className="flex size-9 items-center justify-center rounded-full bg-[#25D366] text-white">
          <WhatsAppMenuIcon className="size-5" />
        </span>
        <span className="min-w-0">
          <span className="block truncate">{t("admin.frontDesk.title")}</span>
          <span className="block truncate text-xs font-normal opacity-70">
            {t("admin.frontDesk.openBubble")}
          </span>
        </span>
      </button>
      <button
      ...
      >
        ...
        <span className="min-w-0">
          <span className="block truncate">{t("admin.chat.title")}</span>
          <span className="block truncate text-xs font-normal opacity-70">
            {t("admin.chat.open")}
          </span>
        </span>
