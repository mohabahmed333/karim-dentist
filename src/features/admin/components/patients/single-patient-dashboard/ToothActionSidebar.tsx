      ...
      <div className="grid grid-cols-2 gap-2">
        {CDT_QUICK_ACTIONS.map((action) => (
          <button
            ...
            className="rounded-lg border border-slate-200 bg-white px-2.5 py-2.5 text-left text-[12px] font-medium text-slate-800 hover:border-blue-600 hover:bg-blue-50 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
          >
